...
const ALL_TABLES = ['progress', 'timetable', 'tests', 'errors', 'formulas', 'dailylogs', 'settings', 'pomodoro', 'dailyplans', 'questions', 'backlog', 'pyqattempts', 'studysessions', 'pypmockresults'] as const
