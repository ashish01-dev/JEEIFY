...
export async function estimateStorageUsage(isPro: boolean): Promise<StorageUsage> {
  ...
  const tables = ['progress', 'timetable', 'tests', 'errors', 'formulas', 'dailyLogs', 'pomodoro', 'dailyPlans', 'questions', 'backlog', 'pyqAttempts', 'studySessions', 'pypMockResults'] as const
