...
const DEFAULT_SETTINGS: Settings = {
  ...
  hideAITutor: false,
  hideSidebarLabels: false,
  hideSidebarPYQ: false,
  hideSidebarBacklog: false,
  hideSidebarJournal: false,
  hideSidebarQuestions: false,
  hideSidebarTests: false,
  hideSidebarRevision: false,
  hideSidebarFormulaVault: false,
  hideSidebarTimetable: false,
  hideSidebarProgress: false,
  hideSidebarCompletion: false,
  hideSidebarSyllabus: false,
  hideSidebarSettings: false,
  dailyQuestionGoal: 20,
  autoNextOnAnswer: false,
  showAnswerHints: true,
  compactUI: false,
  hideDashboardGamification: false,
  hideDashboardHeatmap: false,
  hideDashboardPace: false,
  hideDashboardPlan: false,
  hideDashboardContinue: false,
}
